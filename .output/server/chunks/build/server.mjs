...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-B3BFVvut.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BkYQrfLi.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-C57yzvFD.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-CIib6pdw.mjs')
  },
  {
    name: "projects-category",
    path: "/projects/:category()",
    component: () => import('./_category_-CJZgVaaL.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-wO6bdZ5b.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-RR0GT08n.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DRh1cRU0.mjs'));
