...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Premium interior design studio focusing on minimalist aesthetics."}],"link":[],"style":[],"script":[],"noscript":[],"title":"ASA RONA | Interior Design Studio"};
